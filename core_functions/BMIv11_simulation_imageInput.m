...
%     data.vals_neurons = ones(1,numCells);
%     data.vals_neurons = nansum( TA_CF_lam_reshape , 1 );
...
if frameNum>1
    plotUpdatedOutput(data.vals_neurons(:,1:10) + [1:10]*500, params.timing.duration_plotting, params.timing.frameRate, 'neurons', 1, 1),
...
% %         image_toUse = prctile(im_buffer_rolling_z, zCorrPtile, 3);
% 
