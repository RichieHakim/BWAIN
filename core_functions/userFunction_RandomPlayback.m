...
if ~isnan(counter_frameNum)
    logger.trials(counter_frameNum,1) = counter_frameNum;
    logger.trials(counter_frameNum,2) = CS_quiescence;
    logger.trials(counter_frameNum,3) = ET_trialStart;
    logger.trials(counter_frameNum,4) = CE_trial;
    logger.trials(counter_frameNum,5) = soundVolume;
    logger.trials(counter_frameNum,6) = counter_trialDuration;
    logger.trials(counter_frameNum,7) = CS_threshold;
    logger.trials(counter_frameNum,8) = ET_rewardToneHold; % reward signals
    logger.trials(counter_frameNum,9) = CE_rewardToneHold;
    logger.trials(counter_frameNum,10) = counter_rewardToneHold;
    logger.trials(counter_frameNum,11) = frequencyOverride;
    logger.trials(counter_frameNum,12) = ET_rewardDelivery;
    logger.trials(counter_frameNum,13) = CE_rewardDelivery;
    logger.trials(counter_frameNum,14) = counter_rewardDelivery;
    logger.trials(counter_frameNum,15) = ET_ITI_successful;
    logger.trials(counter_frameNum,16) = CE_ITI_successful;
    logger.trials(counter_frameNum,19) = counter_ITI_successful;
    logger.trials(counter_frameNum,18) = ET_waitForBaseline;
    logger.trials(counter_frameNum,19) = CE_waitForBaseline;
    logger.trials(counter_frameNum,20) = ET_timeout;
    logger.trials(counter_frameNum,21) = CE_timeout;
    logger.trials(counter_frameNum,22) = counter_timeout;
    logger.trials(counter_frameNum,23) = CE_buildingUpStats;
    logger.trials(counter_frameNum,24) = CE_experimentRunning;
    
    logger.decoder(counter_frameNum,1) = cursor;
%     logger.decoder(counter_frameNum,2) = freqToOutput;
    logger.decoder(counter_frameNum,3) = outputVoltageToTeensy;
...
%% FUNCTIONS
    function startSession
        ...
        loggerNames.trials{1} = 'counter_frameNum';
        loggerNames.trials{2} = 'CS_quiescence';
        loggerNames.trials{3} = 'ET_trialStart';
        loggerNames.trials{4} = 'CE_trial';
        loggerNames.trials{5} = 'soundVolume';
        loggerNames.trials{6} = 'counter_trialDuration';
        loggerNames.trials{7} = 'CS_threshold';
        loggerNames.trials{8} = 'ET_rewardToneHold'; % reward signals
        loggerNames.trials{9} = 'CE_rewardToneHold';
        loggerNames.trials{10} = 'counter_rewardToneHold';
        loggerNames.trials{11} = 'frequencyOverride';
        loggerNames.trials{12} = 'ET_rewardDelivery';
        loggerNames.trials{13} = 'CE_rewardDelivery';
        loggerNames.trials{14} = 'counter_rewardDelivery';
        loggerNames.trials{15} = 'ET_ITI_successful';
        loggerNames.trials{16} = 'CE_ITI_successful';
        loggerNames.trials{17} = 'counter_ITI_successful';
        loggerNames.trials{18} = 'ET_waitForBaseline';
        loggerNames.trials{19} = 'CE_waitForBaseline';
        loggerNames.trials{20} = 'ET_timeout';
        loggerNames.trials{21} = 'CE_timeout';
        loggerNames.trials{22} = 'counter_timeout';
        loggerNames.trials{23} = 'CE_buildingUpStats';
        loggerNames.trials{24} = 'CE_experimentRunning';
        
        loggerNames.decoder{1} = 'cursor';
        loggerNames.decoder{2} = 'freqToOutput';
        loggerNames.decoder{3} = 'outputVoltageToTeensy';
