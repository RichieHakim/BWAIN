...
subSampleFactor_runningVals = 30;
...
% tic
    vals_smooth = nanmean(logger_valsROIs( max(1 , counter_frameNum-win_smooth) : counter_frameNum,:),1);
    if mod(counter_frameNum , subSampleFactor_runningVals) == 0
%         tic
