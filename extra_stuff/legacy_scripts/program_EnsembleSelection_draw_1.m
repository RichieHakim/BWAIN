...
directory = 'F:\RH_Local\Rich data\scanimage data\test Mouse\test 2';
file_baseName = 'test_00001_';
...
% framesToUseFromEnd = [0:1000]; % Index of frames to use starting from the end of the video
