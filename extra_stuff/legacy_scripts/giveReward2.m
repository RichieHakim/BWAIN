function giveReward2( solenoidONpref, LEDONpref , solenoid_duration_in_ms, solenoid_delay_in_ms, LED_duration_in_sec, LED_ramping_pref, LED_ramping_duration_in_sec)
global sesh_reward
...
if solenoidONpref && LEDONpref
        traceDuration = max([(solenoid_duration_in_ms*1.1 + solenoid_delay_in_ms)/1000 , LED_duration_in_sec]) * sesh_reward.Rate;
end
if solenoidONpref && ~LEDONpref
        traceDuration = ((solenoid_duration_in_ms*1.1 + solenoid_delay_in_ms)/1000) * sesh_reward.Rate;
end
if ~solenoidONpref && LEDONpref
traceDuration = LED_duration_in_sec * sesh_reward.Rate;
end
...
if solenoidONpref
    delayFrames = round((solenoid_delay_in_ms/1000) * sesh_reward.Rate);
