...
dir_Fall = 'D:\RH_local\data\scanimage data\round 5 experiments\mouse 2_6\20210416\exp\suite2p\plane0';
fileName_Fall = 'Fall.mat';
% Fall variable should be named: 'Fall' (from S2p; contains stat file)
load([dir_Fall '\' fileName_Fall]);

% Use day N (today)
directory_today = 'D:\RH_local\data\scanimage data\round 5 experiments\mouse 2_6\20210417\baseline';
fileName_movie = 'file_000';
%%
% Should be in day N-1 or day 0 folder
directory_weights = 'D:\RH_local\data\scanimage data\round 5 experiments\mouse 2_6\20210417\analysis_lastNight';
fileName_weights = 'weights_dayN.mat';
...
figure; imshowpair(meanIm , spatial_footprints_warped_all.^0.2)
