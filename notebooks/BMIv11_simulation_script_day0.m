...
dir_analysis_day0 = 'D:\RH_local\data\round_6_experiments\mouse_1_19\scanimage_data\20220322\analysis_day0';
...
dir_analysis_dayN =  'D:\RH_local\data\round_6_experiments\mouse_1_19\scanimage_data\20220322\analysis_day0';
...
% directory_movie = 'D:\RH_local\data\scanimage data\round 6 experiments\mouse_1_18\20220215\baseline';
% fileName_movie = 'baseline';
% 
% frames_totalExpected = 54000;
% frames_perFile = 1000;
% 
...
for ii = 1:num_frames
    ...
    %     ii
    if ii<num_frames
        BMIv11_simulation(F_double(cellNumsToUse,ii)' , ii , baselineStuff , trialStuff, num_frames , threshold_reward , threshold_quiescence, num_frames);
...
%         BMIv11_simulation_imageInput(movie_all(:,:,ii) , ii , baselineStuff, trialStuff, num_frames , threshold_reward , threshold_quiescence);
        ...
        [logger , logger_valsROIs2 , numRewardsAcquired] = BMIv11_simulation(F_double(cellNumsToUse,ii)' , ii , baselineStuff , trialStuff, num_frames , threshold_reward , threshold_quiescence, num_frames);
...
%% save
save_dir =  'D:\RH_local\data\round_6_experiments\mouse_1_19\scanimage_data\20220322\analysis_day0';
